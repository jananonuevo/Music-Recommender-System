...
def getGenres(top_genres_user):
    ...
    for i in range(5):
        ...
        elif top_genres_user[i] == 'postgrunge':
...
def newUserRecommendation(model, dataset, userID=None, new_user_feature=None, k=10):
      ...
      #model = trainModel(userID, new_user_feature)
    ...
    #display_side_by_side(songs_recommended[['songID', 'name','artists']])
